...
- To install this project with gui and all its dependencies, add `#egg=anime-downloader[gui]` to the pip command you are using to install it. Example: `pip install git+https://github.com/anime-dl/anime-downloader#egg=anime_downloader[gui]`
